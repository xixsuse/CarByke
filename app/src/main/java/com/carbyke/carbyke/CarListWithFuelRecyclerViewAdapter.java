...
//    setting data
    private void setData(ViewHolder holder, DataForRecyclerView info) {
        ...
        holder.seat_tv.setText(String.valueOf(info.getSeater()));
        //holder.distance_tv.setText(info.());
        //holder.self_pick_up_place_tv.setText(info.());
        holder.km100_price_tv.setText(String.valueOf(info.getW_100kms()));
        //holder.km100_dist_tv.setText(info.());
        holder.km200_price_tv.setText(String.valueOf(info.getW_200kms()));
        //holder.km200_dist_tv.setText(info.());
        holder.km350_price_tv.setText(String.valueOf(info.getW_350kms()));
